...
class shield_medusa(basic_equip):
    ...
    def __init__(self, x=1, y=1):
        ...
        super().__init__(name, sprite, x, y, damage, critic, defense, 5, func=self.use_function, to_player=to_player, battle_effect=self.use_alter_status, desc="Puede convertir en piedra a quien ataque al portador", nonfunc=self.nonuse_function)
