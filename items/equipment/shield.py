...
class shield(basic_equip):
    ...
    def __init__(self, x=1, y=1):
        ...
        super().__init__(name, sprite, x, y, damage, critic, defense, 1, func=self.use_function, to_player=to_player, desc='Es un escudo normal', nonfunc=self.nonuse_function)
