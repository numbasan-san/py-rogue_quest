...
class sword(basic_equip):
    ...
    def __init__(self, x=1, y=1):
        ...
        defense = 0
        to_player = True
        super().__init__(name, sprite, x, y, damage, critic, defense, func=self.use_function, to_player=to_player, desc='Es una espada normal', nonfunc=self.nonuse_function)
